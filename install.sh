...
while [[ "$#" -gt 0 ]]; do
    ...
    -h|--help)
      ...
      echo
      echo "Syntax: bash <(curl -s https://raw.githubusercontent.com/Leo-Galli/phpmyadmin_scripts/main/install.sh) [options]"
      echo
      echo "Options:"
...
source <(curl -s https://raw.githubusercontent.com/Leo-Galli/phpmyadmin_scripts/main/BashSelect.sh)
